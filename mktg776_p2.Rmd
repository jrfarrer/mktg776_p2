...
dish %>%
  ...
  theme_jrf(users_v = "rstudio") + 
  scale_y_continuous(labels = scales::comma) +
  labs(title = "Trend Decomposition to Determine Seasonality", x = NULL, y = "Customers Acquired")
```

We scaled the seasonal component and used it as a covariate. The seasonality covariate proved extremely helpful in explaining the shape of the Dish customer acquisition time series. 
...
After determining the WG model was the most appropriate, we then needed to identify which combination of covariates if any would produce the best model. We run the WG + cov model for all 32 combinations of the five covariate ($2^5 = 32$), which includes no covariates at all. Below are the top 10 models by BIC (a summary of the remaining 22 can be found in the [Appendix]):
